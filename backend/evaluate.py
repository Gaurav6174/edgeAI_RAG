...
async def evaluate(csv_path: str):
    ...
    async with httpx.AsyncClient(timeout=120.0) as client:
        for idx, row in enumerate(dataset):
            ...
            print(f"  → outcome: {outcome} | confidence: {result['confidence']:.2f} | similarity: {similarity:.2f}")
    ...
    report = {
        ...
        "interpretation": {
            "TP":  "Answerable question — system answered correctly",
            "TN":  "Unanswerable question — system correctly said not found",
            "FP":  "System answered when it shouldn't have, or answered wrongly",
            "FN":  "Answerable question — system missed it (said not found)",
        },
